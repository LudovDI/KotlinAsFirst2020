...
class Tests {
    ...
    fun averageStockPrice() {
        ...
        assertEquals(
            mapOf("" to 0.0, "a" to 0.0),
            averageStockPrice(listOf("" to 0.0, "a" to 0.0))
        )
    }
    ...
    fun canBuildFrom() {
        ...
        assertTrue(canBuildFrom(listOf('w', 'a'), "a"))
        assertFalse(canBuildFrom(listOf('w', 'a'), " "))
    ...
    fun propagateHandshakes() {
        ...
        assertEquals(
            mapOf(
                ...
                "22e" to setOf(),
                "367" to setOf(),
                "136" to setOf("173", "1", "1c8", "37f"),
                "6a" to setOf(),
                "d5" to setOf(),
                "135" to setOf(),
                "173" to setOf("1", "1c8", "37f"),
                "152" to setOf(),
                "15b" to setOf(),
            ),
            propagateHandshakes(
    ...
    fun bagPacking() {
        assertEquals(
            setOf("1", "3"),
            bagPacking(
                mapOf("1" to (5 to 3), "2" to (10 to 5), "3" to (6 to 4), "4" to (5 to 2)),
                14
            )
        )
        assertEquals(
