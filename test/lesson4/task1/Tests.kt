...
class Tests {
    ...
    fun russian() {
        ...
        assertEquals("шестьсот четырнадцать тысяч шестьсот девяносто пять", russian(614695))
        ...
        assertEquals("девятьсот тысяч", russian(900000))
        assertEquals("двенадцать", russian(12))
        assertEquals("четыреста тридцать пять тысяч семьсот двадцать четыре", russian(435724))
        assertEquals("восемьсот семьдесят одна тысяча четыреста сорок девять", russian(871449))
        assertEquals("пятьсот девять тысяч семьдесят три", russian(509073))
        assertEquals("четыреста семьдесят тысяч сто восемнадцать", russian(470118))
        assertEquals("сто одиннадцать тысяч сто семьдесят семь", russian(111177))
    }
}